...
export const EDITS = [
...

  {
    ...
    find: '        applied = acceptedFrameDelta(delta);',
  ...
  {
    item: 'B1',
    name: 'the match clock consumes the accepted frame delta rather than raw time',
    file: 'src/core/match.ts',
    find: '      remaining = Math.max(0, remaining - elapsed);',
    replace: '      remaining = Math.max(0, remaining - dt);',
    detectedBy: 'unit',
  },
...
`,
  ...
  {
    item: 'D2',
    name: 'the wait applies each accepted delta exactly once',
    file: 'src/core/match.ts',
    find: '      opponentDelay += elapsed;',
    replace: '      opponentDelay += elapsed * 2;',
    detectedBy: 'unit',
  },
  {
    item: 'D2',
    name: 'the opponent wait consumes the accepted frame delta rather than raw time',
    file: 'src/core/match.ts',
    find: '      opponentDelay += elapsed;',
    replace: '      opponentDelay += dt;',
    detectedBy: 'unit',
  },
  {
    item: 'D6',
